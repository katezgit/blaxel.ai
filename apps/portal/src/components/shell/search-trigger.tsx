...
export function SearchTrigger({ onClick }: SearchTriggerProps) {
  return (
    <button
      ...
      aria-keyshortcuts="/"
      data-slot="search"
      className="flex h-8 w-full max-w-sm cursor-pointer items-center gap-2 rounded-lg border border-form-field-border bg-field-rest px-2.5 typography-body text-muted-foreground transition-[color,background-color,border-color,box-shadow,outline] duration-fast ease-out-standard hover:bg-form-field-surface hover:text-foreground focus-visible:outline-hidden focus-visible:shadow-focus-ring focus-visible:bg-form-field-surface max-md:size-8 max-md:justify-center max-md:border-transparent max-md:bg-transparent max-md:px-0"
    >
